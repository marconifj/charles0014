...
@section('content')
<div class="container">
    <form class="form-horizontal" method="post" action="{{route('updateEntrega')}}">
        ...
        <fieldset>
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="id_status" id="selectIdCliente">
                        @foreach($statuses as $status)
                        <option value="{{$status->id}}" <?php echo $status->id == $entrega->id_status ? 'selected' : '' ?>>{{$status->descricao_status}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <textarea name="obs_entrega" class="form-control" rows="5" id="comment " >{{$entrega->obs_entrega}}</textarea>
                </div>
